                        ...
                        <div class="header__contacts">
                            ...
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="tel:<? the_field('telephone', 2); ?>"><? the_field('telephone', 2); ?></a>
                                    <a href="tel:<? the_field('telephone_2', 2); ?>"><? the_field('telephone_2', 2); ?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
                                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="header__contacts-logo">
                                <address><? the_field('address', 2); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
