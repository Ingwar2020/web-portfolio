        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="158" title="Всплывающая форма вопроса"]') ?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<? the_field('instagram', 2); ?>"  target="_blank" class="footer__social-item">
                            ...
                            <a href="<? the_field('facebook', 2); ?>"  target="_blank" class="footer__social-item">
                            ...
                            <a href="<? the_field('youtube', 2); ?>"  target="_blank" class="footer__social-item">
